...
import { toNestErrors, validateFieldsNatively } from '@xstack/form/utils'
import type { FieldError, FieldValues, Resolver } from 'react-hook-form'

export function parseIssues(issues: readonly StandardSchemaV1.Issue[], validateAllFieldCriteria: boolean) {
 ...
 * ```
 */
export function standardSchemaResolver<Schema extends StandardSchemaV1<FieldValues>>(
  schema: Schema,
  resolverOptions: {
    raw?: boolean
  } = {},
