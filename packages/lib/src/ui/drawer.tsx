...
const DrawerOverlay = ({ className, ...props }: React.ComponentPropsWithRef<typeof DrawerPrimitive.Overlay>) => (
...
const DrawerHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn('grid gap-1.5 p-fl-xs text-center sm:text-left', className)} {...props} />
)
...
const DrawerTitle = ({ className, ...props }: React.ComponentPropsWithRef<typeof DrawerPrimitive.Title>) => (
  <DrawerPrimitive.Title className={cn('text-fl-lg font-medium leading-none tracking-tight', className)} {...props} />
)
